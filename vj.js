...
<script type='text/javascript'>
		var isMobile;
			$(document).ready(function() {
							...
							var items = $(&#39;.tr_bq&#39;);
								if(items.length)
								{   
								    var rm = &quot;<br/><button class='btn btn-sm coppyy myButton newbtn99999' data-link='https://www.quotesdude.com' onclick='copyToClipboard(this)' type='button'><i class='fa fa-copy'/> Copy</button><button class='btn btn-sm whatsapp myButtonwtsp' data-link='https://www.quotesdude.com' onclick='copyToClipboardWhatsapp(this)' type='button'>&#9993; WhatsApp</button>&quot;
                                    $(&#39;blockquote&#39;).append(rm); 
 ...
 $(&quot;span&quot;).css(&quot;background-color&quot;, &quot;&quot;); 
			...
			function copyToClipboard(element) {
				...
				$(&quot;body&quot;).append($temp); 
				var textcoppyed;
				textcoppyed=$(element).closest(&#39;blockquote&#39;).find(&#39;span&#39;).text();
                  if(textcoppyed == &#39;&#39;){
                	  textcoppyed=$(element).closest(&#39;blockquote&#39;).find(&#39;i&#39;).text();
                      }
  
				$temp.val(textcoppyed).select();
			...
			function copyToClipboardWhatsapp(w){
				var texttoWhatsapp;
				 texttoWhatsapp=$(w).closest(&#39;blockquote&#39;).find(&#39;span&#39;).text();
	                  if(texttoWhatsapp == &#39;&#39;){
	                	  texttoWhatsapp=$(w).closest(&#39;blockquote&#39;).find(&#39;i&#39;).text();
	                      }
				var text = texttoWhatsapp;
				var url = $(w).attr(&quot;data-link&quot;);
				var message = encodeURIComponent(text) + &quot; - &quot;	+ encodeURIComponent(url);
				 if (isMobile.any()) { 
					var whatsapp_url = &quot;whatsapp://send?text=&quot;+ message;
					window.location.href = whatsapp_url;
				} else {
					var whatsappweb_url = &quot;https://web.whatsapp.com/send?text=&quot;+ message;
					//alert(whatsappweb_url);
					//window.location.href = whatsappweb_url;
window.open(whatsappweb_url, &quot;_blank&quot;);
				} 
				}
